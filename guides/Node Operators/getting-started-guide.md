...
To get started, install a Network Node in a [supported](/docs/build/requirements) Linux server, such as Debian or Ubuntu (latest) by utilizing our simple [assisted installer](/docs/build/install#assisted-installer) to help onboard as quickly as possible.
...
:::tip
To set up Rust, packages and library dependencies can be tricky. The quickest is to visit the [rustup.rs](https://rustup.rs/). Alternatively, if you haven't already, the build section has a [manual installation](/docs/build/install#manual-installation) document to help.
:::
...
Learn how to create a new Systemd service in the [manual installation](/docs/build/install#manual-installation) document.
...
To avoid having to go through all the steps manually, we recommend reading our [assisted installer](/docs/build/install#assisted-installer) document for quick onboarding.
